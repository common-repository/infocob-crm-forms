...
return [
    'Names' => [
        ...
        'Africa/Bissau' => 'Saa za Greenwich (Bissau)',
        'Africa/Blantyre' => 'Saa za Afrika ya Kati (Blantyre)',
        'Africa/Brazzaville' => 'Saa za Afrika Magharibi (Brazzaville)',
        'Africa/Bujumbura' => 'Saa za Afrika ya Kati (Bujumbura)',
        ...
        'Africa/Kampala' => 'Saa za Afrika Mashariki (Kampala)',
        'Africa/Khartoum' => 'Saa za Afrika ya Kati (Khartoum)',
        'Africa/Kigali' => 'Saa za Afrika ya Kati (Kigali)',
        ...
        'Africa/Malabo' => 'Saa za Afrika Magharibi (Malabo)',
        'Africa/Maputo' => 'Saa za Afrika ya Kati (Maputo)',
        'Africa/Maseru' => 'Saa za Wastani za Afrika Kusini (Maseru)',
        'Africa/Mbabane' => 'Saa za Wastani za Afrika Kusini (Mbabane)',
        ...
        'America/Adak' => 'Saa za Hawaii-Aleutian (Adak)',
        ...
        'America/Denver' => 'Saa za Mountain (Denver)',
        ...
        'America/Guadeloupe' => 'Saa za Atlantiki (Guadeloupe)',
        'America/Guatemala' => 'Saa za Kati (Guatemala)',
        'America/Guayaquil' => 'Saa za Ekwado (Guayaquil)',
        'America/Guyana' => 'Saa za Guyana',
        'America/Halifax' => 'Saa za Atlantiki (Halifax)',
        'America/Havana' => 'Saa za Kuba (Havana)',
        'America/Hermosillo' => 'Saa za pasifiki za Meksiko (Hermosillo)',
        'America/Indiana/Knox' => 'Saa za Kati (Knox, Indiana)',
        'America/Indiana/Marengo' => 'Saa za Mashariki (Marengo, Indiana)',
        'America/Indiana/Petersburg' => 'Saa za Mashariki (Petersburg, Indiana)',
        'America/Indiana/Tell_City' => 'Saa za Kati (Tell City, Indiana)',
        'America/Indiana/Vevay' => 'Saa za Mashariki (Vevay, Indiana)',
        ...
        'America/La_Paz' => 'Saa za Bolivia (La Paz)',
        ...
        'America/Mexico_City' => 'Saa za Kati (Jiji la Mexico)',
        'America/Miquelon' => 'Saa za Saint-Pierre na Miquelon',
        'America/Moncton' => 'Saa za Atlantiki (Moncton)',
        'America/Monterrey' => 'Saa za Kati (Monterrey)',
        'America/Montevideo' => 'Saa za Urugwai (Montevideo)',
        ...
        'America/North_Dakota/Center' => 'Saa za Kati (Center, North Dakota)',
        ...
        'America/Port_of_Spain' => 'Saa za Atlantiki (Port of Spain)',
        ...
        'America/St_Thomas' => 'Saa za Atlantiki (St. Thomas)',
        'America/St_Vincent' => 'Saa za Atlantiki (St. Vincent)',
        ...
        'America/Vancouver' => 'Saa za Pasifiki (Vancouver)',
        ...
        'Antarctica/Mawson' => 'Saa za Mawson',
        ...
        'Asia/Dili' => 'Saa za Timor Mashariki (Dili)',
        'Asia/Dubai' => 'Saa za Wastani za Gulf (Dubai)',
        'Asia/Dushanbe' => 'Saa za Tajikistan (Dushanbe)',
        'Asia/Famagusta' => 'Saa za Mashariki mwa Ulaya (Famagusta)',
        ...
        'Asia/Jerusalem' => 'Saa za Israeli (Jerusalem)',
        'Asia/Kabul' => 'Saa za Afghanistan (Kabul)',
        ...
        'Asia/Kuching' => 'Saa za Malaysia (Kuching)',
        'Asia/Kuwait' => 'Saa za Uarabuni (Kuwait)',
        'Asia/Macau' => 'Saa za Uchina (Macau)',
        'Asia/Magadan' => 'Saa za Magadan',
        'Asia/Makassar' => 'Saa za Indonesia ya Kati (Makassar)',
        'Asia/Manila' => 'Saa za Ufilipino (Manila)',
        ...
        'Asia/Singapore' => 'Saa za Wastani za Singapore',
        'Asia/Srednekolymsk' => 'Saa za Magadan (Srednekolymsk)',
        'Asia/Taipei' => 'Saa za Taipei',
        'Asia/Tashkent' => 'Saa za Uzbekistan (Tashkent)',
        'Asia/Tbilisi' => 'Saa za Jojia (Tbilisi)',
        ...
        'Asia/Yakutsk' => 'Saa za Yakutsk',
        'Asia/Yekaterinburg' => 'Saa za Yekaterinburg',
        ...
        'Atlantic/St_Helena' => 'Saa za Greenwich (St. Helena)',
        'Atlantic/Stanley' => 'Saa za Visiwa vya Falkland (Stanley)',
        ...
        'Australia/Lindeman' => 'Saa za Australia Mashariki (Lindeman)',
        'Australia/Lord_Howe' => 'Saa za Lord Howe',
        ...
        'Europe/Bratislava' => 'Saa za Ulaya ya Kati (Bratislava)',
        ...
        'Europe/Isle_of_Man' => 'Saa za Greenwich (Isle of Man)',
        'Europe/Istanbul' => 'Saa za Uturuki (Istanbul)',
        ...
        'Europe/Luxembourg' => 'Saa za Ulaya ya Kati (Luxembourg)',
        'Europe/Madrid' => 'Saa za Ulaya ya Kati (Madrid)',
        'Europe/Malta' => 'Saa za Ulaya ya Kati (Malta)',
        'Europe/Mariehamn' => 'Saa za Mashariki mwa Ulaya (Mariehamn)',
        'Europe/Minsk' => 'Saa za Moscow (Minsk)',
        'Europe/Monaco' => 'Saa za Ulaya ya Kati (Monaco)',
        'Europe/Moscow' => 'Saa za Moscow',
        'Europe/Oslo' => 'Saa za Ulaya ya Kati (Oslo)',
        'Europe/Paris' => 'Saa za Ulaya ya Kati (Paris)',
        'Europe/Podgorica' => 'Saa za Ulaya ya Kati (Podgorica)',
        'Europe/Prague' => 'Saa za Ulaya ya Kati (Prague)',
        'Europe/Riga' => 'Saa za Mashariki mwa Ulaya (Riga)',
        'Europe/Rome' => 'Saa za Ulaya ya Kati (Rome)',
        ...
        'Pacific/Majuro' => 'Saa za Visiwa vya Marshall (Majuro)',
        'Pacific/Marquesas' => 'Saa za Marquesas',
        'Pacific/Midway' => 'Saa za Samoa (Midway)',
