...
return [
    'Names' => [
        ...
        'Africa/Bissau' => 'Waktu Min Greenwich (Bissau)',
        'Africa/Blantyre' => 'Waktu Afrika Tengah (Blantyre)',
        'Africa/Brazzaville' => 'Waktu Afrika Barat (Brazzaville)',
        'Africa/Bujumbura' => 'Waktu Afrika Tengah (Bujumbura)',
        ...
        'Africa/Kigali' => 'Waktu Afrika Tengah (Kigali)',
        ...
        'Africa/Malabo' => 'Waktu Afrika Barat (Malabo)',
        'Africa/Maputo' => 'Waktu Afrika Tengah (Maputo)',
        'Africa/Maseru' => 'Waktu Piawai Afrika Selatan (Maseru)',
        'Africa/Mbabane' => 'Waktu Piawai Afrika Selatan (Mbabane)',
        ...
        'America/Adak' => 'Waktu Hawaii-Aleutian (Adak)',
        ...
        'America/Denver' => 'Waktu Pergunungan (Denver)',
        ...
        'America/Guatemala' => 'Waktu Pusat (Guatemala)',
        'America/Guayaquil' => 'Waktu Ecuador (Guayaquil)',
        'America/Guyana' => 'Waktu Guyana',
        'America/Halifax' => 'Waktu Atlantik (Halifax)',
        'America/Havana' => 'Waktu Cuba (Havana)',
        'America/Hermosillo' => 'Waktu Pasifik Mexico (Hermosillo)',
        'America/Indiana/Knox' => 'Waktu Pusat (Knox, Indiana)',
        'America/Indiana/Marengo' => 'Waktu Timur (Marengo, Indiana)',
        'America/Indiana/Petersburg' => 'Waktu Timur (Petersburg, Indiana)',
        'America/Indiana/Tell_City' => 'Waktu Pusat (Tell City, Indiana)',
        'America/Indiana/Vevay' => 'Waktu Timur (Vevay, Indiana)',
        ...
        'America/La_Paz' => 'Waktu Bolivia (La Paz)',
        ...
        'America/Montevideo' => 'Waktu Uruguay (Montevideo)',
        ...
        'America/North_Dakota/Center' => 'Waktu Pusat (Center, North Dakota)',
        ...
        'Antarctica/Mawson' => 'Waktu Mawson',
        ...
        'Asia/Dili' => 'Waktu Timor Timur (Dili)',
        'Asia/Dubai' => 'Waktu Piawai Teluk (Dubai)',
        'Asia/Dushanbe' => 'Waktu Tajikistan (Dushanbe)',
        'Asia/Famagusta' => 'Waktu Eropah Timur (Famagusta)',
        ...
        'Asia/Kabul' => 'Waktu Afghanistan (Kabul)',
        ...
        'Asia/Kuching' => 'Waktu Malaysia (Kuching)',
        'Asia/Kuwait' => 'Waktu Arab (Kuwait)',
        'Asia/Macau' => 'Waktu China (Macau)',
        'Asia/Magadan' => 'Waktu Magadan',
        'Asia/Makassar' => 'Waktu Indonesia Tengah (Makassar)',
        'Asia/Manila' => 'Waktu Filipina (Manila)',
        ...
        'Asia/Singapore' => 'Waktu Piawai Singapura',
        'Asia/Srednekolymsk' => 'Waktu Magadan (Srednekolymsk)',
        'Asia/Taipei' => 'Waktu Taipei',
        'Asia/Tashkent' => 'Waktu Uzbekistan (Tashkent)',
        'Asia/Tbilisi' => 'Waktu Georgia (Tbilisi)',
        ...
        'Asia/Yakutsk' => 'Waktu Yakutsk',
        'Asia/Yekaterinburg' => 'Waktu Yekaterinburg',
        ...
        'Atlantic/St_Helena' => 'Waktu Min Greenwich (St. Helena)',
        'Atlantic/Stanley' => 'Waktu Kepulauan Falkland (Stanley)',
        ...
        'Australia/Lindeman' => 'Waktu Australia Timur (Lindeman)',
        'Australia/Lord_Howe' => 'Waktu Lord Howe',
        ...
        'Europe/Bratislava' => 'Waktu Eropah Tengah (Bratislava)',
        ...
        'Europe/Isle_of_Man' => 'Waktu Min Greenwich (Isle of Man)',
        'Europe/Istanbul' => 'Waktu Turkiye (Istanbul)',
        ...
        'Europe/Luxembourg' => 'Waktu Eropah Tengah (Luxembourg)',
        'Europe/Madrid' => 'Waktu Eropah Tengah (Madrid)',
        'Europe/Malta' => 'Waktu Eropah Tengah (Malta)',
        'Europe/Mariehamn' => 'Waktu Eropah Timur (Mariehamn)',
        'Europe/Minsk' => 'Waktu Moscow (Minsk)',
        'Europe/Monaco' => 'Waktu Eropah Tengah (Monaco)',
        'Europe/Moscow' => 'Waktu Moscow',
        'Europe/Oslo' => 'Waktu Eropah Tengah (Oslo)',
        'Europe/Paris' => 'Waktu Eropah Tengah (Paris)',
        'Europe/Podgorica' => 'Waktu Eropah Tengah (Podgorica)',
        'Europe/Prague' => 'Waktu Eropah Tengah (Prague)',
        'Europe/Riga' => 'Waktu Eropah Timur (Riga)',
        'Europe/Rome' => 'Waktu Eropah Tengah (Rome)',
        ...
        'Pacific/Majuro' => 'Waktu Kepulauan Marshall (Majuro)',
        'Pacific/Marquesas' => 'Waktu Marquesas',
        'Pacific/Midway' => 'Waktu Samoa (Midway)',
