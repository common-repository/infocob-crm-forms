	...
	class FieldDate extends Field {
		public function display() {
            ...
            <label class="<?php echo $this->getCssClasses(); ?>">
				...
				<?php } ?>
                <input type="date" name="<?php echo esc_attr($this->nom); ?>" placeholder="<?php echo $libelle; ?>" value="" <?php if($this->required){ ?>required<?php } ?> />
            </label>
			<?php
		}
		...
		public function get() {
            ...
            <label class="' . $cssClasses . '">
                ' . $is_display_libelle . '
                <input type="date" name="' . $nom . '" placeholder="' . $libelle . '" value="" ' . $input_required . ' />
            </label>
			';
		}
