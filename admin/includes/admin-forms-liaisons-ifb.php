...
<form id="configForm" method="POST" action="<?php echo esc_attr('admin-post.php'); ?>" accept-charset="UTF-8">
    <input type="hidden" name="form_type" value="ifb" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div id="selectAction" class="select">
                                            <select name="data[action][<?php echo $name_shortcode; ?>]" size="1">
                                                <option></option>
												<?php foreach(($dataActions ?? []) as $field => $libAction) { ?>
													<?php if(isset($dataDbForm['fieldAssoc']['action'][ $name_shortcode ]) && $dataDbForm['fieldAssoc']['action'][ $name_shortcode ] == $field) { ?>
                                    ...
                                    <td>
										<?php if(isset($dataDbForm['pivot']['action'])) { ?>
											<?php if(in_array($name_shortcode, $dataDbForm['pivot']['action'])) { ?>
                                                <input checked type="checkbox" name="pivot[action][]" value="<?php echo $name_shortcode; ?>" />
											<?php } else { ?>
                                                <input type="checkbox" name="pivot[action][]" value="<?php echo $name_shortcode; ?>" />
											<?php } ?>
										<?php } else { ?>
                                            <input type="checkbox" name="pivot[action][]" value="<?php echo $name_shortcode; ?>" />
										<?php } ?>
                                    ...
                                    <td>
										<?php if(isset($dataDbForm['maj']['action'])) { ?>
											<?php if(in_array($name_shortcode, $dataDbForm['maj']['action'])) { ?>
                                                <input checked type="checkbox" name="maj[action][]" value="<?php echo $name_shortcode; ?>" />
											<?php } else { ?>
                                                <input type="checkbox" name="maj[action][]" value="<?php echo $name_shortcode; ?>" />
											<?php } ?>
										<?php } else { ?>
                                            <input type="checkbox" name="maj[action][]" value="<?php echo $name_shortcode; ?>" />
										<?php } ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div id="selectInventaireAction" class="select">
                                            <select name="data[inventaire-action][<?php echo $name_shortcode; ?>]" size="1">
                                                <option></option>
							                    <?php foreach(($dataInventaires ?? []) as $field => $libInventaire) { ?>
								                    <?php if(isset($dataDbForm['fieldAssoc']['inventaire-action'][ $name_shortcode ]) && $dataDbForm['fieldAssoc']['inventaire-action'][ $name_shortcode ] == $field) { ?>
                                    ...
                                    <td>
					                    <?php if(isset($dataDbForm['pivot']['inventaire-action'])) { ?>
						                    <?php if(in_array($name_shortcode, $dataDbForm['pivot']['inventaire-action'])) { ?>
                                                <input checked type="checkbox" name="pivot[inventaire-action][]" value="<?php echo $name_shortcode; ?>" />
						                    <?php } else { ?>
                                                <input type="checkbox" name="pivot[inventaire-action][]" value="<?php echo $name_shortcode; ?>" />
						                    <?php } ?>
					                    <?php } else { ?>
                                            <input type="checkbox" name="pivot[inventaire-action][]" value="<?php echo $name_shortcode; ?>" />
					                    <?php } ?>
                                    ...
                                    <td>
					                    <?php if(isset($dataDbForm['maj']['inventaire-action'])) { ?>
						                    <?php if(in_array($name_shortcode, $dataDbForm['maj']['inventaire-action'])) { ?>
                                                <input checked type="checkbox" name="maj[inventaire-action][]" value="<?php echo $name_shortcode; ?>" />
						                    <?php } else { ?>
                                                <input type="checkbox" name="maj[inventaire-action][]" value="<?php echo $name_shortcode; ?>" />
						                    <?php } ?>
					                    <?php } else { ?>
                                            <input type="checkbox" name="maj[inventaire-action][]" value="<?php echo $name_shortcode; ?>" />
					                    <?php } ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="select" id="selectContact">
                                            <select name="data[contact][<?php echo $name_shortcode; ?>]" size="1">
                                                <option></option>
												<?php foreach(($dataContact ?? []) as $field => $libContact) { ?>
													<?php if(isset($dataDbForm['fieldAssoc']['contact'][ $name_shortcode ]) && $dataDbForm['fieldAssoc']['contact'][ $name_shortcode ] == $field) { ?>
                                    ...
                                    <td>
										<?php if(isset($dataDbForm['pivot']['contact'])) { ?>
											<?php if(in_array($name_shortcode, $dataDbForm['pivot']['contact'])) { ?>
                                                <input checked type="checkbox" name="pivot[contact][]" value="<?php echo $name_shortcode; ?>" />
											<?php } else { ?>
                                                <input type="checkbox" name="pivot[contact][]" value="<?php echo $name_shortcode; ?>" />
											<?php } ?>
										<?php } else { ?>
                                            <input type="checkbox" name="pivot[contact][]" value="<?php echo $name_shortcode; ?>" />
										<?php } ?>
                                    ...
                                    <td>
										<?php if(isset($dataDbForm['maj']['contact'])) { ?>
											<?php if(in_array($name_shortcode, $dataDbForm['maj']['contact'])) { ?>
                                                <input checked type="checkbox" name="maj[contact][]" value="<?php echo $name_shortcode; ?>" />
											<?php } else { ?>
                                                <input type="checkbox" name="maj[contact][]" value="<?php echo $name_shortcode; ?>" />
											<?php } ?>
										<?php } else { ?>
                                            <input type="checkbox" name="maj[contact][]" value="<?php echo $name_shortcode; ?>" />
										<?php } ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div id="selectInventaireContact" class="select">
                                            <select name="data[inventaire-contact][<?php echo $name_shortcode; ?>]" size="1">
                                                <option></option>
							                    <?php foreach(($dataInventaires ?? []) as $field => $libInventaire) { ?>
								                    <?php if(isset($dataDbForm['fieldAssoc']['inventaire-contact'][ $name_shortcode ]) && $dataDbForm['fieldAssoc']['inventaire-contact'][ $name_shortcode ] == $field) { ?>
                                                        <option selected value="<?php echo $field; ?>"><?php echo $field . " [" . $libInventaire . "]"; ?></option>
								                    <?php } else { ?>
                                                        <option value="<?php echo $field; ?>"><?php echo $field . " [" . $libInventaire . "]"; ?></option>
								                    <?php } ?>
                                    ...
                                    <td>
					                    <?php if(isset($dataDbForm['pivot']['inventaire-contact'])) { ?>
						                    <?php if(in_array($name_shortcode, $dataDbForm['pivot']['inventaire-contact'])) { ?>
                                                <input checked type="checkbox" name="pivot[inventaire-contact][]" value="<?php echo $name_shortcode; ?>" />
						                    <?php } else { ?>
                                                <input type="checkbox" name="pivot[inventaire-contact][]" value="<?php echo $name_shortcode; ?>" />
						                    <?php } ?>
					                    <?php } else { ?>
                                            <input type="checkbox" name="pivot[inventaire-contact][]" value="<?php echo $name_shortcode; ?>" />
					                    <?php } ?>
                                    ...
                                    <td>
					                    <?php if(isset($dataDbForm['maj']['inventaire-contact'])) { ?>
						                    <?php if(in_array($name_shortcode, $dataDbForm['maj']['inventaire-contact'])) { ?>
                                                <input checked type="checkbox" name="maj[inventaire-contact][]" value="<?php echo $name_shortcode; ?>" />
						                    <?php } else { ?>
                                                <input type="checkbox" name="maj[inventaire-contact][]" value="<?php echo $name_shortcode; ?>" />
						                    <?php } ?>
					                    <?php } else { ?>
                                            <input type="checkbox" name="maj[inventaire-contact][]" value="<?php echo $name_shortcode; ?>" />
					                    <?php } ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="select" id="selectInterlocuteur">
                                            <select name="data[interlocuteur][<?php echo $name_shortcode; ?>]" size="1">
                                                <option></option>
												<?php foreach(($dataInterlocuteur ?? []) as $field => $libInterlocuteur) { ?>
													<?php if(isset($dataDbForm['fieldAssoc']['interlocuteur'][ $name_shortcode ]) && $dataDbForm['fieldAssoc']['interlocuteur'][ $name_shortcode ] == $field) { ?>
                                    ...
                                    <td>
										<?php if(isset($dataDbForm['pivot']['interlocuteur'])) { ?>
											<?php if(in_array($name_shortcode, $dataDbForm['pivot']['interlocuteur'])) { ?>
                                                <input checked type="checkbox" name="pivot[interlocuteur][]" value="<?php echo $name_shortcode; ?>" />
											<?php } else { ?>
                                                <input type="checkbox" name="pivot[interlocuteur][]" value="<?php echo $name_shortcode; ?>" />
											<?php } ?>
										<?php } else { ?>
                                            <input type="checkbox" name="pivot[interlocuteur][]" value="<?php echo $name_shortcode; ?>" />
										<?php } ?>
                                    ...
                                    <td>
										<?php if(isset($dataDbForm['maj']['interlocuteur'])) { ?>
											<?php if(in_array($name_shortcode, $dataDbForm['maj']['interlocuteur'])) { ?>
                                                <input checked type="checkbox" name="maj[interlocuteur][]" value="<?php echo $name_shortcode; ?>" />
											<?php } else { ?>
                                                <input type="checkbox" name="maj[interlocuteur][]" value="<?php echo $name_shortcode; ?>" />
											<?php } ?>
										<?php } else { ?>
                                            <input type="checkbox" name="maj[interlocuteur][]" value="<?php echo $name_shortcode; ?>" />
										<?php } ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div id="selectInventaireInterlocuteur" class="select">
                                            <select name="data[inventaire-interlocuteur][<?php echo $name_shortcode; ?>]" size="1">
                                                <option></option>
							                    <?php foreach(($dataInventaires ?? []) as $field => $libInventaire) { ?>
								                    <?php if(isset($dataDbForm['fieldAssoc']['inventaire-interlocuteur'][ $name_shortcode ]) && $dataDbForm['fieldAssoc']['inventaire-interlocuteur'][ $name_shortcode ] == $field) { ?>
                                                        <option selected value="<?php echo $field; ?>"><?php echo $field . " [" . $libInventaire . "]"; ?></option>
								                    <?php } else { ?>
                                                        <option value="<?php echo $field; ?>"><?php echo $field . " [" . $libInventaire . "]"; ?></option>
								                    <?php } ?>
                                    ...
                                    <td>
					                    <?php if(isset($dataDbForm['pivot']['inventaire-interlocuteur'])) { ?>
						                    <?php if(in_array($name_shortcode, $dataDbForm['pivot']['inventaire-interlocuteur'])) { ?>
                                                <input checked type="checkbox" name="pivot[inventaire-interlocuteur][]" value="<?php echo $name_shortcode; ?>" />
						                    <?php } else { ?>
                                                <input type="checkbox" name="pivot[inventaire-interlocuteur][]" value="<?php echo $name_shortcode; ?>" />
						                    <?php } ?>
					                    <?php } else { ?>
                                            <input type="checkbox" name="pivot[inventaire-interlocuteur][]" value="<?php echo $name_shortcode; ?>" />
					                    <?php } ?>
                                    ...
                                    <td>
					                    <?php if(isset($dataDbForm['maj']['inventaire-interlocuteur'])) { ?>
						                    <?php if(in_array($name_shortcode, $dataDbForm['maj']['inventaire-interlocuteur'])) { ?>
                                                <input checked type="checkbox" name="maj[inventaire-interlocuteur][]" value="<?php echo $name_shortcode; ?>" />
						                    <?php } else { ?>
                                                <input type="checkbox" name="maj[inventaire-interlocuteur][]" value="<?php echo $name_shortcode; ?>" />
						                    <?php } ?>
					                    <?php } else { ?>
                                            <input type="checkbox" name="maj[inventaire-interlocuteur][]" value="<?php echo $name_shortcode; ?>" />
					                    <?php } ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="select" id="selectAffaire">
                                            <select name="data[affaire][<?php echo $name_shortcode; ?>]" size="1">
                                                <option></option>
												<?php foreach(($dataAffaire ?? []) as $field => $libAffaire) { ?>
													<?php if(isset($dataDbForm['fieldAssoc']['affaire'][ $name_shortcode ]) && $dataDbForm['fieldAssoc']['affaire'][ $name_shortcode ] == $field) { ?>
                                    ...
                                    <td>
										<?php if(isset($dataDbForm['pivot']['affaire'])) { ?>
											<?php if(in_array($name_shortcode, $dataDbForm['pivot']['affaire'])) { ?>
                                                <input checked type="checkbox" name="pivot[affaire][]" value="<?php echo $name_shortcode; ?>" />
											<?php } else { ?>
                                                <input type="checkbox" name="pivot[affaire][]" value="<?php echo $name_shortcode; ?>" />
											<?php } ?>
										<?php } else { ?>
                                            <input type="checkbox" name="pivot[affaire][]" value="<?php echo $name_shortcode; ?>" />
										<?php } ?>
                                    ...
                                    <td>
										<?php if(isset($dataDbForm['maj']['affaire'])) { ?>
											<?php if(in_array($name_shortcode, $dataDbForm['maj']['affaire'])) { ?>
                                                <input checked type="checkbox" name="maj[affaire][]" value="<?php echo $name_shortcode; ?>" />
											<?php } else { ?>
                                                <input type="checkbox" name="maj[affaire][]" value="<?php echo $name_shortcode; ?>" />
											<?php } ?>
										<?php } else { ?>
                                            <input type="checkbox" name="maj[affaire][]" value="<?php echo $name_shortcode; ?>" />
										<?php } ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div id="selectInventaireAffaire" class="select">
                                            <select name="data[inventaire-affaire][<?php echo $name_shortcode; ?>]" size="1">
                                                <option></option>
							                    <?php foreach(($dataInventaires ?? []) as $field => $libInventaire) { ?>
								                    <?php if(isset($dataDbForm['fieldAssoc']['inventaire-affaire'][ $name_shortcode ]) && $dataDbForm['fieldAssoc']['inventaire-affaire'][ $name_shortcode ] == $field) { ?>
                                                        <option selected value="<?php echo $field; ?>"><?php echo $field . " [" . $libInventaire . "]"; ?></option>
								                    <?php } else { ?>
                                                        <option value="<?php echo $field; ?>"><?php echo $field . " [" . $libInventaire . "]"; ?></option>
								                    <?php } ?>
                                    ...
                                    <td>
					                    <?php if(isset($dataDbForm['pivot']['inventaire-affaire'])) { ?>
						                    <?php if(in_array($name_shortcode, $dataDbForm['pivot']['inventaire-affaire'])) { ?>
                                                <input checked type="checkbox" name="pivot[inventaire-affaire][]" value="<?php echo $name_shortcode; ?>" />
						                    <?php } else { ?>
                                                <input type="checkbox" name="pivot[inventaire-affaire][]" value="<?php echo $name_shortcode; ?>" />
						                    <?php } ?>
					                    <?php } else { ?>
                                            <input type="checkbox" name="pivot[inventaire-affaire][]" value="<?php echo $name_shortcode; ?>" />
					                    <?php } ?>
                                    ...
                                    <td>
					                    <?php if(isset($dataDbForm['maj']['inventaire-affaire'])) { ?>
						                    <?php if(in_array($name_shortcode, $dataDbForm['maj']['inventaire-affaire'])) { ?>
                                                <input checked type="checkbox" name="maj[inventaire-affaire][]" value="<?php echo $name_shortcode; ?>" />
						                    <?php } else { ?>
                                                <input type="checkbox" name="maj[inventaire-affaire][]" value="<?php echo $name_shortcode; ?>" />
						                    <?php } ?>
					                    <?php } else { ?>
                                            <input type="checkbox" name="maj[inventaire-affaire][]" value="<?php echo $name_shortcode; ?>" />
					                    <?php } ?>
                ...
                <div style="display: none;" id="data-produit" class="data-produit container-table">
                    ...
                    <div class="module-table hide">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="select" id="selectProduit">
                                            <select name="data[produit][<?php echo $name_shortcode; ?>]" size="1">
                                                <option></option>
												<?php foreach(($dataProduit ?? []) as $field => $libProduit) { ?>
													<?php if(isset($dataDbForm['fieldAssoc']['produit'][ $name_shortcode ]) && $dataDbForm['fieldAssoc']['produit'][ $name_shortcode ] == $field) { ?>
                                    ...
                                    <td>
										<?php if(isset($dataDbForm['pivot']['produit'])) { ?>
											<?php if(in_array($name_shortcode, $dataDbForm['pivot']['produit'])) { ?>
                                                <input checked type="checkbox" name="pivot[produit][]" value="<?php echo $name_shortcode; ?>" />
											<?php } else { ?>
                                                <input type="checkbox" name="pivot[produit][]" value="<?php echo $name_shortcode; ?>" />
											<?php } ?>
										<?php } else { ?>
                                            <input type="checkbox" name="pivot[produit][]" value="<?php echo $name_shortcode; ?>" />
										<?php } ?>
                                    ...
                                    <td>
										<?php if(isset($dataDbForm['maj']['produit'])) { ?>
											<?php if(in_array($name_shortcode, $dataDbForm['maj']['produit'])) { ?>
                                                <input checked type="checkbox" name="maj[produit][]" value="<?php echo $name_shortcode; ?>" />
											<?php } else { ?>
                                                <input type="checkbox" name="maj[produit][]" value="<?php echo $name_shortcode; ?>" />
											<?php } ?>
										<?php } else { ?>
                                            <input type="checkbox" name="maj[produit][]" value="<?php echo $name_shortcode; ?>" />
										<?php } ?>
                        ...
                        <table id="tableInventaireProduit" class="inventaire" border="0" style="text-align: center;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div id="selectInventaireProduit" class="select">
                                            <select name="data[inventaire-produit][<?php echo $name_shortcode; ?>]" size="1">
                                                <option></option>
							                    <?php foreach(($dataInventaires ?? []) as $field => $libInventaire) { ?>
								                    <?php if(isset($dataDbForm['fieldAssoc']['inventaire-produit'][ $name_shortcode ]) && $dataDbForm['fieldAssoc']['inventaire-produit'][ $name_shortcode ] == $field) { ?>
                                                        <option selected value="<?php echo $field; ?>"><?php echo $field . " [" . $libInventaire . "]"; ?></option>
								                    <?php } else { ?>
                                                        <option value="<?php echo $field; ?>"><?php echo $field . " [" . $libInventaire . "]"; ?></option>
								                    <?php } ?>
                                    ...
                                    <td>
					                    <?php if(isset($dataDbForm['pivot']['inventaire-produit'])) { ?>
						                    <?php if(in_array($name_shortcode, $dataDbForm['pivot']['inventaire-produit'])) { ?>
                                                <input checked type="checkbox" name="pivot[inventaire-produit][]" value="<?php echo $name_shortcode; ?>" />
						                    <?php } else { ?>
                                                <input type="checkbox" name="pivot[inventaire-produit][]" value="<?php echo $name_shortcode; ?>" />
						                    <?php } ?>
					                    <?php } else { ?>
                                            <input type="checkbox" name="pivot[inventaire-produit][]" value="<?php echo $name_shortcode; ?>" />
					                    <?php } ?>
                                    ...
                                    <td>
					                    <?php if(isset($dataDbForm['maj']['inventaire-produit'])) { ?>
						                    <?php if(in_array($name_shortcode, $dataDbForm['maj']['inventaire-produit'])) { ?>
                                                <input checked type="checkbox" name="maj[inventaire-produit][]" value="<?php echo $name_shortcode; ?>" />
						                    <?php } else { ?>
                                                <input type="checkbox" name="maj[inventaire-produit][]" value="<?php echo $name_shortcode; ?>" />
						                    <?php } ?>
					                    <?php } else { ?>
                                            <input type="checkbox" name="maj[inventaire-produit][]" value="<?php echo $name_shortcode; ?>" />
					                    <?php } ?>
		                    ...
		                    <?php } ?>
		                    <?php if(isset($dataDbForm['fieldAssoc']['inventaire-produit']['moreData'])) { ?>
			                    <?php $compteur = 0; ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div id="selectTicket" class="select">
                                            <select name="data[ticket][<?php echo $name_shortcode; ?>]" size="1">
                                                <option></option>
									            <?php foreach(($dataTicket ?? []) as $field => $libTicket) { ?>
										            <?php if(isset($dataDbForm['fieldAssoc']['ticket'][ $name_shortcode ]) && $dataDbForm['fieldAssoc']['ticket'][ $name_shortcode ] == $field) { ?>
                                    ...
                                    <td>
							            <?php if(isset($dataDbForm['pivot']['ticket'])) { ?>
								            <?php if(in_array($name_shortcode, $dataDbForm['pivot']['ticket'])) { ?>
                                                <input checked type="checkbox" name="pivot[ticket][]" value="<?php echo $name_shortcode; ?>" />
								            <?php } else { ?>
                                                <input type="checkbox" name="pivot[ticket][]" value="<?php echo $name_shortcode; ?>" />
								            <?php } ?>
							            <?php } else { ?>
                                            <input type="checkbox" name="pivot[ticket][]" value="<?php echo $name_shortcode; ?>" />
							            <?php } ?>
                                    ...
                                    <td>
							            <?php if(isset($dataDbForm['maj']['ticket'])) { ?>
								            <?php if(in_array($name_shortcode, $dataDbForm['maj']['ticket'])) { ?>
                                                <input checked type="checkbox" name="maj[ticket][]" value="<?php echo $name_shortcode; ?>" />
								            <?php } else { ?>
                                                <input type="checkbox" name="maj[ticket][]" value="<?php echo $name_shortcode; ?>" />
								            <?php } ?>
							            <?php } else { ?>
                                            <input type="checkbox" name="maj[ticket][]" value="<?php echo $name_shortcode; ?>" />
							            <?php } ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div id="selectInventaireTicket" class="select">
                                            <select name="data[inventaire-ticket][<?php echo $name_shortcode; ?>]" size="1">
                                                <option></option>
							                    <?php foreach(($dataInventaires ?? []) as $field => $libInventaire) { ?>
								                    <?php if(isset($dataDbForm['fieldAssoc']['inventaire-ticket'][ $name_shortcode ]) && $dataDbForm['fieldAssoc']['inventaire-ticket'][ $name_shortcode ] == $field) { ?>
                                                        <option selected value="<?php echo $field; ?>"><?php echo $field . " [" . $libInventaire . "]"; ?></option>
								                    <?php } else { ?>
                                                        <option value="<?php echo $field; ?>"><?php echo $field . " [" . $libInventaire . "]"; ?></option>
								                    <?php } ?>
                                    ...
                                    <td>
					                    <?php if(isset($dataDbForm['pivot']['inventaire-ticket'])) { ?>
						                    <?php if(in_array($name_shortcode, $dataDbForm['pivot']['inventaire-ticket'])) { ?>
                                                <input checked type="checkbox" name="pivot[inventaire-ticket][]" value="<?php echo $name_shortcode; ?>" />
						                    <?php } else { ?>
                                                <input type="checkbox" name="pivot[inventaire-ticket][]" value="<?php echo $name_shortcode; ?>" />
						                    <?php } ?>
					                    <?php } else { ?>
                                            <input type="checkbox" name="pivot[inventaire-ticket][]" value="<?php echo $name_shortcode; ?>" />
					                    <?php } ?>
                                    ...
                                    <td>
					                    <?php if(isset($dataDbForm['maj']['inventaire-ticket'])) { ?>
						                    <?php if(in_array($name_shortcode, $dataDbForm['maj']['inventaire-ticket'])) { ?>
                                                <input checked type="checkbox" name="maj[inventaire-ticket][]" value="<?php echo $name_shortcode; ?>" />
						                    <?php } else { ?>
                                                <input type="checkbox" name="maj[inventaire-ticket][]" value="<?php echo $name_shortcode; ?>" />
						                    <?php } ?>
					                    <?php } else { ?>
                                            <input type="checkbox" name="maj[inventaire-ticket][]" value="<?php echo $name_shortcode; ?>" />
					                    <?php } ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div id="selectInventaireContrat" class="select">
                                            <select name="data[inventaire-contrat][<?php echo $name_shortcode; ?>]" size="1">
                                                <option></option>
							                    <?php foreach(($dataInventaires ?? []) as $field => $libInventaire) { ?>
								                    <?php if(isset($dataDbForm['fieldAssoc']['inventaire-contrat'][ $name_shortcode ]) && $dataDbForm['fieldAssoc']['inventaire-contrat'][ $name_shortcode ] == $field) { ?>
                                                        <option selected value="<?php echo $field; ?>"><?php echo $field . " [" . $libInventaire . "]"; ?></option>
								                    <?php } else { ?>
                                                        <option value="<?php echo $field; ?>"><?php echo $field . " [" . $libInventaire . "]"; ?></option>
								                    <?php } ?>
                                    ...
                                    <td>
					                    <?php if(isset($dataDbForm['pivot']['inventaire-contrat'])) { ?>
						                    <?php if(in_array($name_shortcode, $dataDbForm['pivot']['inventaire-contrat'])) { ?>
                                                <input checked type="checkbox" name="pivot[inventaire-contrat][]" value="<?php echo $name_shortcode; ?>" />
						                    <?php } else { ?>
                                                <input type="checkbox" name="pivot[inventaire-contrat][]" value="<?php echo $name_shortcode; ?>" />
						                    <?php } ?>
					                    <?php } else { ?>
                                            <input type="checkbox" name="pivot[inventaire-contrat][]" value="<?php echo $name_shortcode; ?>" />
					                    <?php } ?>
                                    ...
                                    <td>
					                    <?php if(isset($dataDbForm['maj']['inventaire-contrat'])) { ?>
						                    <?php if(in_array($name_shortcode, $dataDbForm['maj']['inventaire-contrat'])) { ?>
                                                <input checked type="checkbox" name="maj[inventaire-contrat][]" value="<?php echo $name_shortcode; ?>" />
						                    <?php } else { ?>
                                                <input type="checkbox" name="maj[inventaire-contrat][]" value="<?php echo $name_shortcode; ?>" />
						                    <?php } ?>
					                    <?php } else { ?>
                                            <input type="checkbox" name="maj[inventaire-contrat][]" value="<?php echo $name_shortcode; ?>" />
					                    <?php } ?>
                ...
                <div style="display: none;" id="data-historique" class="data-historique container-table">
                    ...
                    <div class="module-table hide">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="select" id="selectHistorique">
                                            <select name="data[historique][<?php echo $name_shortcode; ?>]" size="1">
                                                <option></option>
												<?php foreach(($dataHistorique ?? []) as $field => $libHistorique) { ?>
													<?php if(isset($dataDbForm['fieldAssoc']['historique'][ $name_shortcode ]) && $dataDbForm['fieldAssoc']['historique'][ $name_shortcode ] == $field) { ?>
                                    ...
                                    <td>
										<?php if(isset($dataDbForm['pivot']['historique'])) { ?>
											<?php if(in_array($name_shortcode, $dataDbForm['pivot']['historique'])) { ?>
                                                <input checked type="checkbox" name="pivot[historique][]" value="<?php echo $name_shortcode; ?>" />
											<?php } else { ?>
                                                <input type="checkbox" name="pivot[historique][]" value="<?php echo $name_shortcode; ?>" />
											<?php } ?>
										<?php } else { ?>
                                            <input type="checkbox" name="pivot[historique][]" value="<?php echo $name_shortcode; ?>" />
										<?php } ?>
                                    ...
                                    <td>
										<?php if(isset($dataDbForm['maj']['historique'])) { ?>
											<?php if(in_array($name_shortcode, $dataDbForm['maj']['historique'])) { ?>
                                                <input checked type="checkbox" name="maj[historique][]" value="<?php echo $name_shortcode; ?>" />
											<?php } else { ?>
                                                <input type="checkbox" name="maj[historique][]" value="<?php echo $name_shortcode; ?>" />
											<?php } ?>
										<?php } else { ?>
                                            <input type="checkbox" name="maj[historique][]" value="<?php echo $name_shortcode; ?>" />
										<?php } ?>
                        ...
                        <table id="tableInventaireHistorique" class="inventaire" border="0" style="text-align: center;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div id="selectInventaireHistorique" class="select">
                                            <select name="data[inventaire-historique][<?php echo $name_shortcode; ?>]" size="1">
                                                <option></option>
							                    <?php foreach(($dataInventaires ?? []) as $field => $libInventaire) { ?>
								                    <?php if(isset($dataDbForm['fieldAssoc']['inventaire-historique'][ $name_shortcode ]) && $dataDbForm['fieldAssoc']['inventaire-historique'][ $name_shortcode ] == $field) { ?>
                                                        <option selected value="<?php echo $field; ?>"><?php echo $field . " [" . $libInventaire . "]"; ?></option>
								                    <?php } else { ?>
                                                        <option value="<?php echo $field; ?>"><?php echo $field . " [" . $libInventaire . "]"; ?></option>
								                    <?php } ?>
                                    ...
                                    <td>
					                    <?php if(isset($dataDbForm['pivot']['inventaire-historique'])) { ?>
						                    <?php if(in_array($name_shortcode, $dataDbForm['pivot']['inventaire-historique'])) { ?>
                                                <input checked type="checkbox" name="pivot[inventaire-historique][]" value="<?php echo $name_shortcode; ?>" />
						                    <?php } else { ?>
                                                <input type="checkbox" name="pivot[inventaire-historique][]" value="<?php echo $name_shortcode; ?>" />
						                    <?php } ?>
					                    <?php } else { ?>
                                            <input type="checkbox" name="pivot[inventaire-historique][]" value="<?php echo $name_shortcode; ?>" />
					                    <?php } ?>
                                    ...
                                    <td>
					                    <?php if(isset($dataDbForm['maj']['inventaire-historique'])) { ?>
						                    <?php if(in_array($name_shortcode, $dataDbForm['maj']['inventaire-historique'])) { ?>
                                                <input checked type="checkbox" name="maj[inventaire-historique][]" value="<?php echo $name_shortcode; ?>" />
						                    <?php } else { ?>
                                                <input type="checkbox" name="maj[inventaire-historique][]" value="<?php echo $name_shortcode; ?>" />
						                    <?php } ?>
					                    <?php } else { ?>
                                            <input type="checkbox" name="maj[inventaire-historique][]" value="<?php echo $name_shortcode; ?>" />
					                    <?php } ?>
		                    ...
		                    <?php } ?>
		                    <?php if(isset($dataDbForm['fieldAssoc']['inventaire-historique']['moreData'])) { ?>
			                    <?php $compteur = 0; ?>
    ...
    <div class="box-plugin">
		<?php if($dataDbForm['sendmail'] ?? true) { ?>
        ...
        <input class="inputPlugin" data-type="ifb" id="deleteData" type="button" value="<?php _e("Delete form", "infocob-crm-forms"); ?>" />
    </div>
</form>
